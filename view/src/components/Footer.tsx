      ...
      <div className="footer__bottom">
        <div className="container footer__bottom-inner">
          ...
          <div className="footer__social-row">
            <a href={SOCIAL_LINKS.xiaohongshu} target="_blank" rel="noopener noreferrer" className="footer__social-link" aria-label="小红书">
            ...
            <a href={SOCIAL_LINKS.douyin} target="_blank" rel="noopener noreferrer" className="footer__social-link" aria-label="抖音">
              <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
