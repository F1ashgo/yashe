...
import './Sidebar.css'
import { SOCIAL_LINKS as SOCIAL_URLS } from '../config/social'
    ...
    <>
      <aside className="sidebar">
        ...
        <div className="sidebar__contact">
          <a href="tel:400-000-0000" className="sidebar__link" aria-label="电话">
            <Phone size={18} />
          </a>
        </div>
      </aside>
