          ...
          <div className="con-grid">
            ...
            <div className="con-info">
              <div className="con-info__card">
                <h3>联系方式</h3>
                <ul>
                  <li><Phone size={18} /><div><span>电话</span><a href="tel:19518935554">195-1893-5554</a></div></li>
                  <li><Mail size={18} /><div><span>邮箱</span><a href="mailto:frdshkg@gmail.com">frdshkg@gmail.com</a></div></li>
